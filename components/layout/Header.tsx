            ...
            <nav className={`flex flex-col gap-4 ${isRtl ? 'font-cairo text-right' : 'font-dm text-left'}`}>
              ...
              <div className="flex items-center justify-between">
                <div className="bg-navy-brand/5 px-3.5 py-1.5 rounded-full flex items-center gap-4 border border-navy-brand/5 w-fit">
                  <a href="https://www.instagram.com/islamtebyan/" target="_blank" rel="noopener noreferrer" className="text-navy-brand/60 hover:text-gold transition-colors" aria-label="Instagram" title="Instagram">
                    <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect>
                      <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path>
                      <line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line>
                  ...
                  <a href="https://www.facebook.com/profile.php?id=61590678633766" target="_blank" rel="noopener noreferrer" className="text-navy-brand/60 hover:text-gold transition-colors" aria-label="Facebook" title="Facebook">
                    <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                    </svg>
                  </a>
                  <a href="https://www.tiktok.com/@isalm_tebyan/" target="_blank" rel="noopener noreferrer" className="text-navy-brand/60 hover:text-gold transition-colors" aria-label="TikTok" title="TikTok">
                    <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M9 12a4 4 0 1 0 4 4V4a5 5 0 0 0 5 5"></path>
                    </svg>
                  </a>
