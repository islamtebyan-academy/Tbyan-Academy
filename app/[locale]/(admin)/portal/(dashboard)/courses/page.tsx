            ...
            >
              ...
              <div className="p-4 border-t border-gold/10 flex items-center justify-between gap-3 relative z-10">
                <Link
                  ...
                  title={isRtl ? 'تعديل بيانات الكارت' : 'Edit Card Details'}
                ...
                >
                  <Edit3 size={11} />
                  <span>{isRtl ? 'تعديل الكارت' : 'Edit Card'}</span>
                </Link>

                <Link
                  href={`/${locale}/portal/courses?id=${course.id}&tab=content`}
                  title={isRtl ? 'تعديل محتوى الصفحة' : 'Edit Page Content'}
                ...
                >
                  <FileText size={11} />
                  <span>{isRtl ? 'تعديل الصفحة' : 'Edit Page'}</span>
                </Link>
